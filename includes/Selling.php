...
// Query to fetch user details including phone number and email address
$sql = "SELECT phoneNumber, emailAddress FROM users WHERE userId = ?";
...
// Set variables
$phoneNumber = $user['phoneNumber'] ?? ''; // Set a default value if null
$emailAddress = $user['emailAddress'] ?? ''; // Set a default value if null
...
<div class="modal fade" id="startSellingModal" tabindex="-1" aria-labelledby="startSellingModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="sellerconfig.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="sellerIdType" class="form-label">Type of ID</label>
                        <select name="sellerIdType" id="sellerIdType" class="form-select" required>
                    ...
                    <div id="addressFields" style="display:none;">
                        <div class="mb-3">
                            ...
                            <select name="city" id="city" class="form-select" onchange="handleCityChange()" required>
                        ...
                        <div class="mb-3" id="barangayContainer" style="display:none;">
