...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!preg_match('/^\d{11}$/', $phoneNumber)) {
        ...
        header("Location: seller_profile.php"); // Update this to redirect to seller_profile.php
        exit();
    }
    ...
    header("Location: seller_profile.php"); // Updated to redirect to seller_profile.php
    exit();
} else {
